...
The code takes all the files with inflammation scores from patients in every data set and calculates the mean, minimum and maximum inflammation for each day.
